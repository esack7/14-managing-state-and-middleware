...
(function(module) {
  ...
  // This function renters the compiled data to the handlebards template on the index.html page. NewArticle.create() calles this. This does not call another function.
